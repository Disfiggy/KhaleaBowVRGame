...
namespace RootMotion.Dynamics {
	...
	public partial class PuppetMaster: MonoBehaviour {
		...
		void Start() {
#if UNITY_EDITOR
			if (UnityEngine.Profiling.Profiler.enabled && visualizeTargetPose) {
				Debug.Log("Switch 'Visualize Target Pose' off when profiling PuppetMaster.", transform);
				visualizeTargetPose = false;
			}
#endif
